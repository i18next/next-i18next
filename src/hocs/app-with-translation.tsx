  ...
  class AppWithTranslation extends React.Component<Props> {
    ...
    static async getServerSideProps(ctx) {
      ...
      */
      ...
      /* Call getServerSideProps on our wrapped _app */
      let wrappedComponentProps: WrappedComponentProps = { pageProps: {} }
      if (WrappedComponent.getServerSideProps) {
        wrappedComponentProps = await WrappedComponent.getServerSideProps(ctx)
      }
      if (typeof wrappedComponentProps.pageProps === 'undefined') {
        consoleMessage(
          'error',
          'If you have a getServerSideProps method in your custom _app.js file, you must explicitly return pageProps. For more information, see: https://github.com/zeit/next.js#custom-app',
        )
      }
    ...
    static async getStaticProps(ctx) {
      ...
      */
      ...
      /* Call getStaticProps on our wrapped _app */
      let wrappedComponentProps: WrappedComponentProps = { pageProps: {} }
      if (WrappedComponent.getStaticProps) {
        wrappedComponentProps = await WrappedComponent.getStaticProps(ctx)
      }
      if (typeof wrappedComponentProps.pageProps === 'undefined') {
        consoleMessage(
          'error',
          'If you have a getStaticProps method in your custom _app.js file, you must explicitly return pageProps. For more information, see: https://github.com/zeit/next.js#custom-app',
        )
      }
